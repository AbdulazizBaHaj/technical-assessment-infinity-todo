...
<body>
                ...
                ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="../group/showGroup.php?id=<?php echo $row['id'] ?>&nameGroup=<?php echo $row['name'] ?>">Edit Checklist Group</a>
                            ...
                            <?php } ?>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="../group/delete_group.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-danger">Delete Checklist Group</button></a>
                        </div>
                    </li>
                <?php }
                ?>
    ...
    <div class="container mt-5">
        ...
        <form action="../task/insertTask.php" method="post">
            <!-- form content stays the same -->
        </form>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <form action="../task/taskDone.php" method="post">
                        ...
                        <form action="../task/delete_task.php" method="post">
                            ...
                            <input type="text" hidden value="<?php echo $_GET['nameChecklist'] ?>" name="nameChecklist">
                            <input type="text" hidden value="<?php echo $row['checklist_id'] ?>" name="checklist_id">
                            <td><a href="../task/delete_task.php?id=<?php echo $_GET['id'] ?>&nameChecklist=<?php echo $_GET['nameChecklist'] ?>&task_id=<?php echo $row['id'] ?>"><button class="btn btn-outline-danger" type="submit">Delete</button></a></td>
                        </form>
                    </tr>
                <?php
                    $count = $count + 1;
